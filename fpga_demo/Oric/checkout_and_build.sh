...
VHDL_FILE_LIST="reset_logic.vhd microdisc_dummy.vhd apple2_disk/dpram_dummy.vhd apple2_disk/floppy_track_dummy.sv oricatmostop_ice40.vhd oricatmostop_gowin.vhd oricatmostop_sim.vhd divn.vhd oricatmos.vhd"
