...
LIST="1_install.sh fpga_build_pnr.sh fpga_build_yosys.sh fpga_packages.sh fpga_iceprogduino.sh fpga_sudo_install.sh fpga_sudo_uninstall.sh start_salae.sh"
